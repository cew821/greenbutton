  ...
  describe Parser do
    ...
    describe :usage_point do
      ...
      it "should have at least one usage_point" do
        expect(gb.usage_points.first.class).to eq UsagePoint
      ...
      it "has defined local_time_parameters" do
        expect(usage_point.local_time_parameters).to be_a(LocalTimeParameters)
      end
      ...
      describe :electric_power_usage_summary do
        ...
        it{ should be_a ElectricPowerUsageSummary }
      ...
      describe :meter_reading do
        ...
        it "has one ReadingType" do
          expect(meter_reading.reading_type).to be_a(ReadingType)
        end
